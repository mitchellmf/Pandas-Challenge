...
merge_df_men_sum = merge_df_men_sum.rename(columns= {'Price_y' : 'Total Price' , 'Price_x' : 'Price'})
...
merge_df_men_mean = merge_df_men_mean.rename(columns= {'Price_y' : 'Total Price' , 'Price_x' : 'Price'})
...
merge_df_women_sum = merge_df_women_sum.rename(columns= {'Price_y' : 'Total Price' , 'Price_x' : 'Price'})
...
merge_df_women_mean = merge_df_women_mean.rename(columns= {'Price_y' : 'Total Price' , 'Price_x' : 'Price'})
...
sum_price_agegroup_A = purch_df_agegroup_A["Price"].sum()
print(f"Total Revenue for Age Group 0-9: {sum_price_agegroup_A}")
sum_price_agegroup_B = purch_df_agegroup_B["Price"].sum()
print(f"Total Revenue for Age Group 10-19: {sum_price_agegroup_B}")
sum_price_agegroup_C = purch_df_agegroup_C["Price"].sum()
print(f"Total Revenue for Age Group 20-29: {sum_price_agegroup_C}")
sum_price_agegroup_D = purch_df_agegroup_D["Price"].sum()
print(f"Total Revenue for Age Group 30-39: {sum_price_agegroup_D}")
sum_price_agegroup_E = purch_df_agegroup_E["Price"].sum()
